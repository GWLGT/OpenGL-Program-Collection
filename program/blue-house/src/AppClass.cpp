...
App::App(int Width, int Height, const char* Title) {
  // Initialize GLFW
  if (!glfwInit()) {
    Utils::PrintLog(MESSAGE_ERROR, "Failed to Initialize GLFW!");
    ...
    Utils::PrintLog(MESSAGE_OK, "GLFW Initialized Successfully!");
  }
  ...
  if (Window == nullptr) {
    Utils::PrintLog(MESSAGE_ERROR, "Failed to Create the Window!");
    throw std::runtime_error("Window Creation Gone Wrong!");
  } else {
    Utils::PrintLog(MESSAGE_OK, "Window Created Successfully!");
  }
  glfwMakeContextCurrent(Window);

  // Initialize GLAD
  if (!gladLoadGLLoader((GLADloadproc)glfwGetProcAddress)) {
    Utils::PrintLog(MESSAGE_ERROR, "Failed to Initialize GLAD!");
    throw std::runtime_error("GLAD Initialization Gone Wrong!");
  } else {
    Utils::PrintLog(MESSAGE_OK, "GLAD Initialized Successfully!");
  }
