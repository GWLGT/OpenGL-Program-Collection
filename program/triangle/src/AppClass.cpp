...
App::App(int Width, int Height, const char* Title) {
  // Initialize GLFW
  if (!glfwInit()) {
    std::cout << Utils::Color::Red << "ERROR: Failed to Initialize GLFW! EXITING... " << Utils::Color::Orange << "LOG:" << Utils::Color::Reset << std::endl;
  ...
  if (Window == nullptr) {
    std::cout << Utils::Color::Red << "ERROR: Failed to Create the Window! EXITING... " << Utils::Color::Orange << "LOG:" << Utils::Color::Reset << std::endl;
  ...
  if (!gladLoadGLLoader((GLADloadproc)glfwGetProcAddress)) {
    std::cout << Utils::Color::Red << "ERROR: Failed to Initialize GLAD! EXITING... " << Utils::Color::Orange << "LOG:" << Utils::Color::Reset << std::endl;
